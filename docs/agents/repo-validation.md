...
lastReviewedNote: "Reviewed Issue #152 required FTMultiLang validation tightening; the existing TypeScript verification and PR proof requirements remain sufficient."
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
